...
var game = (function () {
    ...
    function preloadImages () {
        for (var i = 1; i <= 8; i++) {
            ...
            evilImage.src = 'images/ship.png';
            evilImages.animation[i-1] = evilImage;
            var bossImage = new Image();
            bossImage.src = 'images/enemy_ship.png';
            bossImages.animation[i-1] = bossImage;
        }
        evilImages.killed.src = 'images/dead.png';
        bossImages.killed.src = 'images/dead.png';
        bgMain = new Image();
        bgMain.src = 'images/wallpaper1.png';
        bgBoss = new Image();
        bgBoss.src = 'images/wallpaper2.png';
        playerShotImage = new Image();
        playerShotImage.src = 'images/shoot.png';
        evilShotImage = new Image();
        evilShotImage.src = 'images/enemyshoot.png';
        playerKilledImage = new Image();
        playerKilledImage.src = 'images/dead.png';
    ...
    function showGameOver() {
        bufferctx.fillStyle="#9E0808";
        bufferctx.font="bold 35px Montserrat, sans-serif";
